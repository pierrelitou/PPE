        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.trim().length() > 0 && password.trim().length() > 0) {
                    ...
                    Toast.makeText(getApplicationContext() ,"You need to enter a username and a password", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        //Tests données utilisateurs
                        String firstname=jObj.getString(TAG_FIRSTNAME);
